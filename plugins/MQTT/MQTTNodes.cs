...
namespace VVVV.Nodes.MQTT
{
    ...
    [PluginInfo(Name = "Send",
                ...
                AutoEvaluate = true)]
    #endregion PluginInfo
    public class MQTTSendRawNode : IPluginEvaluate, IPartImportsSatisfiedNotification
    {
        #region pins
        [Input("Client")]
        public Pin<MqttClient> FInClient;
        ...
        [Input("Message")]
        public ISpread<Stream> FInMessage;
        ...
        private void FInClient_Disconnected(object sender, PinConnectionEventArgs args)
        {
            if (FInClient.Count() > 0 && FClient != null)
            {
                FClient.MqttMsgPublished -= FClient_MqttMsgPublished;
                FClient = null;
            }
    ...
    [PluginInfo(Name = "Receive",
                ...
                AutoEvaluate = true)]
    #endregion PluginInfo
    public class MQTTReceiveRawNode : IPluginEvaluate, IPartImportsSatisfiedNotification
    {
        #region pins
        [Input("Client")]
        public Pin<MqttClient> FInClient;
        ...
        [Output("Message")]
        public ISpread<Stream> FOutMessage;
